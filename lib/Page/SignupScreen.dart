            ...
            children: [
              ...
              FadeInUp(
                  ...
                  child: ElevatedButton(onPressed: () async {
                    ...
                    {
                      Fluttertoast.showToast(msg: 'Нужно заполнить все поля');
                      EasyLoading.dismiss();
                    }
                    ...
                    EasyLoading.dismiss();
                    Fluttertoast.showToast(msg: "Регистрация прошла успешна!");
              ...
              GestureDetector(
                ...
                child: FadeInUp(
                    duration: const Duration(milliseconds: 1000),
                    child: const Card(child: Text(' Аккаунт с таким логином уже существует ', style: TextStyle(color: Colors.lightGreen,fontWeight: FontWeight.bold),))),
              ),
